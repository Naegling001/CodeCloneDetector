...
public class BlockJUnit4ClassRunner extends ParentRunner<FrameworkMethod> {
    ...
    private BlockJUnit4ClassRunnerProduct blockJUnit4ClassRunnerProduct = new BlockJUnit4ClassRunnerProduct();
    ...
    protected void runChild(final FrameworkMethod method, RunNotifier notifier) {
        ...
        if (isIgnored(method)) {
            ...
            Statement statement = statementMethod(method);
            runLeaf(statement, description, notifier);
        }
    }

    private Statement statementMethod(final FrameworkMethod method) {
        Statement statement;
        try {
    ...
    protected Statement methodBlock(final FrameworkMethod method) {
        Object test = test(method);
        Statement statement = methodInvoker(method, test);
        statement = blockJUnit4ClassRunnerProduct.possiblyExpectingExceptions(method, test, statement);
        statement = blockJUnit4ClassRunnerProduct.withPotentialTimeout(method, test, statement);
    ...
    private Object test(final FrameworkMethod method) {
        Object test = null;
        try {
    ...
    protected Statement possiblyExpectingExceptions(FrameworkMethod method,
        ...
        return blockJUnit4ClassRunnerProduct.possiblyExpectingExceptions(method,
                test, next);
    }
    ...
    protected Statement withPotentialTimeout(FrameworkMethod method,
            Object test, Statement next) {
        return blockJUnit4ClassRunnerProduct.withPotentialTimeout(method, test,
                next);
    }
