The file JArchitectReport.xsl is provided as an example to define your own xsl to build your own report.
To define your own Xsl sheet, reference it from:
CppDepend Interactive UI > Project Properties Panel > Report Tab > Scroll Down > Use you own Xsl sheet to build report
